...
interface IConfluenceParameters {
  content: string;
  context?: string;
  spaceKey?: string;
  limit?: number;
  ...
  implements vscode.LanguageModelTool<IConfluenceParameters>
{
  private getConfluenceConfig(): ConfluenceConfig | null {
    const config = vscode.workspace.getConfiguration("confluenceChatTool");
            ...
            JSON.stringify(
              {
                ...
                requiredSettings: [
                  "confluenceChatTool.baseUrl",
                  "confluenceChatTool.email",
                  "confluenceChatTool.apiToken",
                ],
                helpUrl:
...
export function registerConfluenceTools(context: vscode.ExtensionContext) {
...
export function activate(context: vscode.ExtensionContext) {
  registerConfluenceTools(context);
}
